...
NT.vs.NT <- results(dds, 
                          contrast = c("condition", "NT", "NT"),
                          pAdjustMethod = "BH",
                          test = "Wald", alpha = 0.05)

write.table(as.data.frame(NT.vs.NT),
            file = "NT.vs.NT.txt",
            quote = FALSE,
            sep = "\t",
            row.names = TRUE)
...
siVps4A_66.vs.NT <- results(dds, 
                                  contrast = c("condition", "siVps4A_66", "NT"),
                                  pAdjustMethod = "BH",
                                  test = "Wald", alpha = 0.05)

write.table(as.data.frame(siVps4A_66.vs.NT),
            file = "siVps4A_66.vs.NT.txt",
            quote = FALSE,
            sep = "\t",
            row.names = TRUE)

siVps4A_68.vs.NT <- results(dds, 
                                  contrast = c("condition", "siVps4A_68", "NT"),
                                  pAdjustMethod = "BH",
                                  test = "Wald", alpha = 0.05)

write.table(as.data.frame(siVps4A_68.vs.NT),
            file = "siVps4A_68.vs.NT.txt",
            quote = FALSE,
            sep = "\t",
            row.names = TRUE)

siVps4B_72.vs.NT <- results(dds, 
                                  contrast = c("condition", "siVps4B_72", "NT"),
                                  pAdjustMethod = "BH",
                                  test = "Wald", alpha = 0.05)

write.table(as.data.frame(siVps4B_72.vs.NT),
            file = "siVps4B_72.vs.NT.txt",
            quote = FALSE,
            sep = "\t",
            row.names = TRUE)

siVps4B_73.vs.NT <- results(dds, 
                                  contrast = c("condition", "siVps4B_73", "NT"),
                                  pAdjustMethod = "BH",
                                  test = "Wald", alpha = 0.05)

write.table(as.data.frame(siVps4B_73.vs.NT),
            file = "siVps4B_73.vs.NT.txt",
            quote = FALSE,
            sep = "\t",
            row.names = TRUE)


siVps4AB_68_72.vs.NT <- results(dds, 
                                      contrast = c("condition", "siVps4AB_68_72", "NT"),
                                      pAdjustMethod = "BH",
                                      test = "Wald", alpha = 0.05)

write.table(as.data.frame(siVps4AB_68_72.vs.NT),
            file = "siVps4AB_68_72.vs.NT.txt",
            quote = FALSE,
            sep = "\t",
            row.names = TRUE)

siVps4AB_66_73.vs.NT <- results(dds, 
                                      contrast = c("condition", "siVps4AB_66_73", "NT"),
                                      pAdjustMethod = "BH",
                                      test = "Wald", alpha = 0.05)

write.table(as.data.frame(siVps4AB_66_73.vs.NT),
            file = "siVps4AB_66_73.vs.NT.txt",
            quote = FALSE,
            sep = "\t",
            row.names = TRUE)
